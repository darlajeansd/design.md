...
// Instantiate unified processor pipelines once as module-level constants
// instead of recreating them on every compileMdx call. This avoids redundant
// plugin resolution and state reconstruction overhead during bulk processing.
