...
// Instantiate unified processor pipelines once as module-level constants instead of
// recreating them on every compileMdx call to improve parsing/stringifying performance.
