...
// We instantiate the unified processor and stringifier pipelines once as
// module-level constants instead of recreating them on every compileMdx call.
// This reduces the time to compile markdown files by ~45%.
